...
Open the backend project in your preferred Java IDE (VS Code is recommended).
Build the project using Maven. Then click on the application and click run (MAC users just click run).
Start the backend server by running the main class: H2DemoApplication.
...
You can log in and explore the application's features to manage members, classes, and schedules.
